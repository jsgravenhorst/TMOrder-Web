  ...
  <body>
	...
	<div id='wrapper'>
		...
		<?php
			...
			$query_cliente = "INSERT INTO proveedor(nombre_proveedor,direccion,email,telefono)
			...
			include('../Admin/menu.php');
					...
					<div class='container-fluid'>
						<div class='row'>
							<div class='panel panel-primary'>
				                            <div class='alert alert-success'>Nuevo Proveedor</div>
				...
				echo"<div id='page-wrapper'>
					<div class='container-fluid'>
						<div class='row'>
						<div class='panel panel-primary'>
				                            <div class='alert alert-warning'>Nuevo Proveedor</div>
				                            <div class='panel-body'>
				                                <div class='row'>
				                                    <div class='col-md-12'>
