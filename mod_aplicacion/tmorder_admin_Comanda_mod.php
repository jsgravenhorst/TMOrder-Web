  ...
  <body>
	...
	<div id='wrapper'>
		...
		<?php
			...
			$query_comanda = "UPDATE comanda
								SET nombre_comanda = '$nombre',
								parametro = '$parametro'
			...
			include('../Admin/menu.php');
					...
					<div class='container-fluid'>
						<div class='row'>
							<div class='panel panel-primary'>
				                            <div class='alert alert-success'>Modificar Comanda</div>
				...
				echo"<div id='page-wrapper'>
					<div class='container-fluid'>
						<div class='row'>
						<div class='panel panel-primary'>
				                            <div class='alert alert-warning'>Modificar Comanda</div>
				                            <div class='panel-body'>
				                                <div class='row'>
				                                    <div class='col-md-12'>
