  ...
  <body>
	...
	<div id='wrapper'>
		...
		<?php
			...
			$query_usuario = "INSERT INTO usuario(nombre_usuario,apellido,usuario,passw,correo, estado)
						VALUES('$nombre','$apellido','$usuario','$password','$email','$estado')";
			...
			include('../Admin/menu.php');
					...
					<div class='container-fluid'>
						<div class='row'>
							<div class='panel panel-primary'>
				                            <div class='alert alert-success'>Nuevo Usuario</div>
				...
				echo"<div id='page-wrapper'>
					<div class='container-fluid'>
						<div class='row'>
						<div class='panel panel-primary'>
				                            <div class='alert alert-warning'>Nuevo Usuario</div>
				                            <div class='panel-body'>
				                                <div class='row'>
				                                    <div class='col-md-12'>
