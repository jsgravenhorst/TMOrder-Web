  ...
  <body>
	...
	<div id='wrapper'>
		...
		<?php
			...
			$query_cliente = "INSERT INTO cliente(nombre_cliente,apellidos,direccion,email,telefono, empresa)
						VALUES('$nombre','$apellidos','$direccion','$email','$telefono','$empresa')";
			...
			include('../Admin/menu.php');
					...
					<div class='container-fluid'>
						<div class='row'>
							<div class='panel panel-primary'>
				                            <div class='alert alert-success'>Nuevo Cliente</div>
				...
				echo"<div id='page-wrapper'>
					<div class='container-fluid'>
						<div class='row'>
						<div class='panel panel-primary'>
				                            <div class='alert alert-warning'>Nuevo Cliente</div>
				                            <div class='panel-body'>
				                                <div class='row'>
				                                    <div class='col-md-12'>
			...
			echo"
				...
				<br>
				<div class='col-md-12'>
					<div><a class='btn btn-primary btn-large' style='float:right;' href='../Admin/clientes.php'>Continuar</a></div>
				</div>
			";
