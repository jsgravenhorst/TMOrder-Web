  ...
  <body>
	...
	<div id='wrapper'>
		...
		<?php
			...
			$query_categoria = "UPDATE complemento
								SET nombre_complemento = '$nombrecomp',
			...
			include('../Admin/menu.php');
					...
					<div class='container-fluid'>
						<div class='row'>
							<div class='panel panel-primary'>
				                            <div class='alert alert-success'>Modificar Complemento</div>
				...
				echo"<div id='page-wrapper'>
					<div class='container-fluid'>
						<div class='row'>
						<div class='panel panel-primary'>
				                            <div class='alert alert-warning'>Modificar Complemento</div>
				                            <div class='panel-body'>
				                                <div class='row'>
				                                    <div class='col-md-12'>
