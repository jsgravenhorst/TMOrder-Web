  ...
  <body>
	...
	<div id='wrapper'>
		...
		<?php
			...
			$query_subcategoria = "DELETE FROM subcategoria
								WHERE idcategoria = $idcategoria";

			$sql_subcategoria  = mysqli_query( $db->connect(), $query_subcategoria  );

			$query_categoria = "DELETE FROM categoria
								WHERE idcategoria = $idcategoria";
			...
			include('../Admin/menu.php');
					...
					<div class='container-fluid'>
						<div class='row'>
							<div class='panel panel-primary'>
				                            <div class='alert alert-success'>Eliminar Categoria</div>
				...
				echo"<div id='page-wrapper'>
					<div class='container-fluid'>
						<div class='row'>
						<div class='panel panel-primary'>
				                            <div class='alert alert-warning'>Eliminar Categoria</div>
				                            <div class='panel-body'>
				                                <div class='row'>
				                                    <div class='col-md-12'>
			...
			echo"
				...
				<br>
				<div class='col-md-12'>
					<div><a class='btn btn-primary btn-large' style='float:right;' href='../Admin/categorias.php'>Continuar</a></div>
				</div>
			";
