  ...
  <body>
	...
	<div id='wrapper'>
		...
		<?php
			...
			$query_categoria = "UPDATE subcategoria
								SET nombre_subcat = '$nombresubcat',
			...
			include('../Admin/menu.php');
					...
					<div class='container-fluid'>
						<div class='row'>
							<div class='panel panel-primary'>
				                            <div class='alert alert-success'>Modificar SubCategoria</div>
				...
				echo"<div id='page-wrapper'>
					<div class='container-fluid'>
						<div class='row'>
						<div class='panel panel-primary'>
				                            <div class='alert alert-warning'>Modificar SubCategoria</div>
				                            <div class='panel-body'>
				                                <div class='row'>
				                                    <div class='col-md-12'>
