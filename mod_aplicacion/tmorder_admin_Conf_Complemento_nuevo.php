  ...
  <body>
	...
	<div id='wrapper'>
		...
		<?php
			...
			$query_complemento = "INSERT INTO complemento(nombre_complemento,idsubcategoria)
						VALUES('$nombrecomp',$idSubCategoria)";

			$sql_complemento  = mysqli_query( $db->connect(), $query_complemento  );
			...
			include('../Admin/menu.php');
					...
					<div class='container-fluid'>
						<div class='row'>
							<div class='panel panel-primary'>
				                            <div class='alert alert-success'>Nuevo Complemento</div>
				...
				echo"<div id='page-wrapper'>
					<div class='container-fluid'>
						<div class='row'>
						<div class='panel panel-primary'>
				                            <div class='alert alert-warning'>Nuevo Complemento</div>
				                            <div class='panel-body'>
				                                <div class='row'>
				                                    <div class='col-md-12'>
			...
			echo"
				...
				<br>
				<div class='col-md-12'>
					<div><a class='btn btn-primary btn-large' style='float:right;' href='../Admin/conf_complemento.php'>Continuar</a></div>
				</div>
			";
