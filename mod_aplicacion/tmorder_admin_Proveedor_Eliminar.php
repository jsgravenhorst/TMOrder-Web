  ...
  <body>
	...
	<div id='wrapper'>
		...
		<?php
			...
			$idproveedor	 = $_GET['var'];

			$query_proveedor = "DELETE FROM proveedor
								WHERE idproveedor = $idproveedor";

			$sql_proveedor  = mysqli_query( $db->connect(), $query_proveedor  );
			...
			include('../Admin/menu.php');
					...
					<div class='container-fluid'>
						<div class='row'>
							<div class='panel panel-primary'>
				                            <div class='alert alert-success'>Eliminar Proveedor</div>
				...
				echo"<div id='page-wrapper'>
					<div class='container-fluid'>
						<div class='row'>
						<div class='panel panel-primary'>
				                            <div class='alert alert-warning'>Eliminar Proveedor</div>
				                            <div class='panel-body'>
				                                <div class='row'>
				                                    <div class='col-md-12'>
			...
			echo"
				...
				<br>
				<div class='col-md-12'>
					<div><a class='btn btn-primary btn-large' style='float:right;' href='../Admin/proveedores.php'>Continuar</a></div>
				</div>
			";
