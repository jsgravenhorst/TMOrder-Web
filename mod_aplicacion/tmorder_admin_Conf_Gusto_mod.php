  ...
  <body>
	...
	<div id='wrapper'>
		...
		<?php
			...
			$idgusto	 = $_POST['idgusto'];
			$nombre 	 = $_POST['nombre'];

			$query_gusto = "UPDATE gusto
								SET nombre_gusto = '$nombre'
								WHERE idgusto = $idgusto";

			$sql_gusto = mysqli_query( $db->connect(), $query_gusto  );
			...
			include('../Admin/menu.php');
					...
					<div class='container-fluid'>
						<div class='row'>
							<div class='panel panel-primary'>
				                            <div class='alert alert-success'>Modificar Gusto</div>
				...
				echo"<div id='page-wrapper'>
					<div class='container-fluid'>
						<div class='row'>
						<div class='panel panel-primary'>
				                            <div class='alert alert-warning'>Modificar Gusto</div>
				                            <div class='panel-body'>
				                                <div class='row'>
				                                    <div class='col-md-12'>
			...
			echo"
				...
				<br>
				<div class='col-md-12'>
					<div><a class='btn btn-primary btn-large' style='float:right;' href='../Admin/conf_gusto.php'>Continuar</a></div>
				</div>
			";
