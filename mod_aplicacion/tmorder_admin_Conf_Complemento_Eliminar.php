  ...
  <body>
	...
	<div id='wrapper'>
		...
		<?php
			...
			$idcomplemento	 = $_GET['var'];

			$query_complemento = "DELETE FROM complemento
			...
			include('../Admin/menu.php');
					...
					<div class='container-fluid'>
						<div class='row'>
							<div class='panel panel-primary'>
				                            <div class='alert alert-success'>Eliminar Complemento</div>
				...
				echo"<div id='page-wrapper'>
					<div class='container-fluid'>
						<div class='row'>
						<div class='panel panel-primary'>
				                            <div class='alert alert-warning'>Eliminar Complemento</div>
				                            <div class='panel-body'>
				                                <div class='row'>
				                                    <div class='col-md-12'>
