	...
	<div id='wrapper'>
		...
		<?php
			...
			include('../Admin/menu.php');
					...
					<div class='container-fluid'>
						<div class='row'>
							<div class='panel panel-primary'>
				                            <div class='alert alert-success'>Eliminar Sub Categoria</div>
				...
				echo"<div id='page-wrapper'>
					<div class='container-fluid'>
						<div class='row'>
						<div class='panel panel-primary'>
				                            <div class='alert alert-warning'>Eliminar Sub Categoria</div>
				                            <div class='panel-body'>
				                                <div class='row'>
				                                    <div class='col-md-12'>
			...
			echo"
				...
				<br>
				<div class='col-md-12'>
					<div><a class='btn btn-primary btn-large' style='float:right;' href='../Admin/subcategorias.php'>Continuar</a></div>
				</div>
			";
